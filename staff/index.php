...
<head>
  ...
  <title>PHP Staff Side Patient Entry</title>
</head>

<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #ec8edb;">
    PHP Staff Side Patient Entry
  </nav>
  ...
  <div class="container">
    ...
    ?>
    <a href="insert.php" class="btn btn-dark mb-3">Add New Patient</a>
