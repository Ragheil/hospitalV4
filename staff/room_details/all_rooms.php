...
<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
 ...
 <br><hr>
    ...
    <a href="http://localhost:3000/staff/room_details/not_vacants_room.php" class="btn btn-dark mb-3"> NOT VACANT ROOM</a>
    <p>VIEW VACANT ROOM</p>
    <a href="http://localhost:3000/staff/room_details/vacants_rooms.php" class="btn btn-dark mb-3">  VACANT ROOM</a>
 <br><hr>s
