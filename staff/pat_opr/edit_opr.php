...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_query($conn, $sql)) {
        header("Location: http://localhost:3000/admin/pat_opr/pat_opr_list.php?msg=Record updated successfully");
        exit;
    } else {
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post" style="width:50vw; min-width:300px;">
                ...
                <div class="container d-flex justify-content-center">
                    ...
                    <a style="float: right;" href="pat_opr_list.php" class="btn btn-danger">Cancel</a>
                </div>
            </form>
        </div>
    </div>
