...
if (isset($_POST["submit"])) {
    ...
    $salary = $_POST['salary'];
    $payment_due = $_POST['salary'];


    $sql = "UPDATE `doc_reg` SET `salary`='$salary' WHERE doctor_id = '$id'";
    ...
    $sql = "SELECT * FROM `doc_reg` WHERE `doctor_id` = '$id'";
    $result = mysqli_query($conn, $sql);
   ...
   <div class="container"style="border-radius: 48px;background: #88c4f1; box-shadow:  5px 5px 10px #4c5650,-5px -5px 10px #0079db; width: 900px;">
      ...
      <div class="container d-flex justify-content-center" >
         <form action="" method="post" style="width:50vw; min-width:300px;">
            ...
            <input type="text" class="form-control" name="salary" placeholder="Payment Due" value="<?php echo $row['salary'] ?>"  >
        </div>
         </form>
      </div>
   </div>
